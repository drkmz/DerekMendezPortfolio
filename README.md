...
| Variable | Value | Use |
|----------|-------|-----|
| `--navy` | `#0d1f3c` | Primary text, headings, buttons |
| `--navy-mid` | `#162847` | Hover states |
| `--navy-light` | `#1e3560` | Gradients |
| `--blue-accent` | `#4a7fc1` | Links, tags, highlights |
| `--blue-soft` | `#c8d9f0` | Subtle accents |
| `--white` | `#f8f9fc` | Page background |
| `--off-white` | `#eef1f7` | Card backgrounds |

### Typography

- **Headings:** DM Sans (Google Fonts) — clean, modern, geometric
- **Body:** Outfit (Google Fonts) — readable, friendly, professional

### Wireframe

```
┌─────────────────────────────────────────┐
│  NAV: Derek Mendez    Home Projects About Contact │
├─────────────────────────────────────────┤
│                                         │
...
│ │ Description...|                     │ │
│ ├───────────────┼─────────────────────┤ │
│ │ [PLACEHOLDER] │ 03 IN PROGRESS      │ │
│ │               │ SmartPlate          │ │
│ ├───────────────┼─────────────────────┤ │
│ │ 04 IN PROGRESS│ [PLACEHOLDER]       │ │
│ │ FugitiveFinder│                     │ │
│ └─────────────────────────────────────┘ │
├─────────────────────────────────────────┤
│  FOOTER: Derek Mendez  © 2025  GH  LI  │
└─────────────────────────────────────────┘
```
...
- **JavaScript (ES6)** — IntersectionObserver, event listeners, DOM manipulation
...
- [FBI Wanted API](https://api.fbi.gov/wanted/v1/list) — used in FugitiveFinder project
- [USDA FoodData Central API](https://fdc.nal.usda.gov/api-guide.html) — used in SmartPlate project
